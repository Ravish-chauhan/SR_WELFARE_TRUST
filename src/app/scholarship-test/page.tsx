                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-[#366861]/15 overflow-hidden">
                        ...
                        <div className="p-8 text-center">
                            ...
                            <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 mb-5 text-left">
                                ...
                                <p className="text-amber-700 text-sm font-bold">16 August 2026</p>
                        ...
                        {step === 4 && (
                            <>
                                ...
                                <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 flex items-start gap-2">
                                    ...
                                    <div>
                                        <p className="text-amber-800 text-xs font-semibold">Expected Exam Date: <span className="text-amber-900">16 August 2026</span></p>
